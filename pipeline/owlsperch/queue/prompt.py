...
_KIND_RULES: dict[str, list[str]] = {
    ...
    "class": [
        ...
        'anyway, with `text_md` as the empty string `""`, rather than',
        "inventing a description or leaving it out of `class_features`",
        "altogether -- every Special-column token that is not bleed must",
        "have a matching `class_features` entry at its first level, and",
        "that entry's `name` should match the Special cell's own spelling",
        '(e.g. plural "Bonus Feats" vs. singular "Bonus feat" -- match the',
        "cell's own wording, don't invent a different form).",
    ],
    "prestige_class": [
